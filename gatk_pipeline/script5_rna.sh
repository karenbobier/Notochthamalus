...
###################################################################################################
 ...
 time gatk GenotypeGVCFs \
         -R ${ref_genome} \
         --variant ${basedir}noto_all_invd.rna.g.vcf \
         -O ${basedir}noto_all_invd.rna.vcf

##################################################################################################
###zip and index vcf
##################################################################################################
cat noto_all_invd.rna.vcf | bgzip -c > noto_all_invd.rna.vcf.gz
tabix noto_all_invd.rna.vcf.gz
