...
basedir="/scratch/keb27269/noto/gacrctest2/assemblies/"
#mkdir $basedir
cd $basedir
...
hmmscan --cpu 20 --domtblout pfam_db/pfam.domtblout /scratch/keb27269/noto/pfam_db/Pfam-A.hmm /scratch/keb27269/noto/noto_1.5.ORP.fasta.transdecoder_dir/longest_orfs.pep

TransDecoder.Predict -t /scratch/keb27269/noto/gacrctest2/assemblies/noto_1.5.ORP.fasta --retain_pfam_hits /scratch/keb27269/noto/pfam_db/pfam.domtblout --retain_blastp_hits blastp.outfmt6
