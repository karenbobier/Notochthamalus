...
#make file header
cat ${basedir}/fastas_by_pop/J9344521/between_group_product_results.txt  |awk "NR==1" > ${basedir}/noto_between_group_product_results.txt
...
for ID in $sequence_ids
  do
    cat ${basedir}/fastas_by_pop/${ID}/between_group_product_results.txt  |awk "NR==2" >> noto_between_group_product_results.txt
done
